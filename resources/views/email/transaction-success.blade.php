  ...
  <div style="background-color:#e4e6eb;">
    ...
    <div style="background:#ffffff;background-color:#ffffff;margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#ffffff;background-color:#ffffff;width:100%;">
        <tbody>
          <tr>
            <td style="border-bottom:1px dashed #eeee;direction:ltr;font-size:0px;padding:20px 0;padding-bottom:0px;padding-top:0px;text-align:center;">
                          ...
                          <tbody>
                            <tr>
                              <td style="width:170px;">
                                <img alt="" height="auto" src="{{url ('frontend/images/bumantara_logo@2x.png')}}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="170" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:30px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Playfair Display, Times New Roman, Serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#051334;">Don't Forget Your E-Ticket !</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                          ...
                          <tbody>
                            <tr>
                              <td style="width:550px;">
                                <img alt="" height="auto" src="{{ url ('storage/'.$data->trip_package->galleries[0]->image) }}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <div style="font-family:Assistant, Helvetica, Arial, Sans-Serif;font-size:18px;line-height:20px;text-align:left;color:#071c4d;">Hi, {{ $data->user->name }} ! <br><br> Tiket digital kamu sudah berhasil di cetak. <br> Booking ID <strong>#{{ $data->id }}</strong></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              ...
                              <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                                <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#071c4d;font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                  ...
                                  <tr>
                                    ...
                                    <td style="text-align: right;">{{$data->trip_package->title}}</td>
                                  </tr>
                                  <tr>
                                    <td><strong>Date</strong></td>
                                    <td style="text-align: right;">{{ $data->trip_package->departure_date }}</td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
              ...
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                  <tbody>
                    <tr>
                      <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, Arial, Sans-Serif;font-size:18px;line-height:20px;text-align:left;color:#071c4d;">Need Help ?</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
                      ...
                      <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                          <tr>
                            ...
                            <td style="font-size: 18px; padding-left: 10px; color: #071c4d; font-family: Assistant, Helvetica, Arial, sans-serif"> support@bumantara.com <br> 022-1901-8384 </td>
                          </tr>
                        </table>
                      </td>
                    </tr>
                  ...
                  <tbody>
                    <tr>
                      <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                        <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#6E6E6E;">2020 Copyright Bumantara • All rights reserved</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
